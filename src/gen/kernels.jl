...
This kernel's link was sourced on 2023-11-07.
...
"""
A FK kernel of size 19.6 KB, linked from https://naif.jpl.nasa.gov [1].
Calling this variable like a function will return a path to the file, downloading 
to scratchspace if necessary.
...
[1] https://naif.jpl.nasa.gov/pub/naif/generic_kernels/pck/earth_000101_240129_231105.bpc
...
Summary for: earth_000101_240129_231105.bpc
 
Frame: ITRF93 (3000)
       Start of Interval (ET)              End of Interval (ET)
       -----------------------------       -----------------------------
       2000 JAN 01 00:01:04.183            2024 JAN 29 00:01:09.184
 

```
"""
const earth_000101_240129_231105 = PCK("https://naif.jpl.nasa.gov/pub/naif/generic_kernels/pck/earth_000101_240129_231105.bpc")
...
"""
A PCK kernel of size 12.4 KB, linked from https://naif.jpl.nasa.gov [1].
Calling this variable like a function will return a path to the file, downloading 
to scratchspace if necessary.
